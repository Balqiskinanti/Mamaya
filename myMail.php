...
define('GUSER', 'johnlegendecad123@gmail.com'); // GMail username to access SMTP mail server
define('GPWD', 'jfcgecjfdahljhlq'); // GMail password to access SMTP mail server
